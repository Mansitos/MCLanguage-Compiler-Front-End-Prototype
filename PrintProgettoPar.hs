...
instance Print AbsProgettoPar.Ident where
  prt _ (AbsProgettoPar.Ident i) = doc $ showString i

instance Print AbsProgettoPar.Boolean where
  prt i = \case
    AbsProgettoPar.Boolean_true -> prPrec i 0 (concatD [doc (showString "true")])
    AbsProgettoPar.Boolean_false -> prPrec i 0 (concatD [doc (showString "false")])
    AbsProgettoPar.Boolean_True -> prPrec i 0 (concatD [doc (showString "True")])
    AbsProgettoPar.Boolean_False -> prPrec i 0 (concatD [doc (showString "False")])

instance Print AbsProgettoPar.S where
  prt i = \case
    AbsProgettoPar.StartCode statements -> prPrec i 0 (concatD [prt 0 statements])

instance Print AbsProgettoPar.STATEMENTS where
  prt i = \case
...
instance Print AbsProgettoPar.PARAMETERS where
  prt i = \case
...
instance Print AbsProgettoPar.VARIABLETYPE where
  prt i = \case
...
instance Print AbsProgettoPar.VARDECLIST where
  prt i = \case
    AbsProgettoPar.VariableDeclarationSingle vardecid -> prPrec i 0 (concatD [prt 0 vardecid])

instance Print AbsProgettoPar.VARDECID where
  prt i = \case
...
instance Print AbsProgettoPar.IDENTLIST where
  prt i = \case
...
instance Print AbsProgettoPar.LISTELEMENTARRAY where
  prt i = \case
...
instance Print AbsProgettoPar.TYPEEXPRESSION where
  prt i = \case
...
instance Print AbsProgettoPar.RANGEEXP where
  prt i = \case
...
instance Print AbsProgettoPar.PRIMITIVETYPE where
  prt i = \case
...
instance Print AbsProgettoPar.CONDITIONALSTATE where
  prt i = \case
...
instance Print AbsProgettoPar.WHILESTATEMENT where
  prt i = \case
...
instance Print AbsProgettoPar.DOSTATEMENT where
  prt i = \case
...
instance Print AbsProgettoPar.FORSTATEMENT where
  prt i = \case
...
instance Print AbsProgettoPar.FORALLSTATEMENT where
  prt i = \case
...
instance Print AbsProgettoPar.INDEXVARDEC where
  prt i = \case
    AbsProgettoPar.IndexVarDeclaration id_ -> prPrec i 0 (concatD [prt 0 id_])

instance Print AbsProgettoPar.ELSESTATEMENT where
  prt i = \case
...
instance Print AbsProgettoPar.RETURNSTATEMENT where
  prt i = \case
...
instance Print AbsProgettoPar.CTRLDECSTATEMENT where
  prt i = \case
...
instance Print AbsProgettoPar.EXPRESSIONSTATEMENT where
  prt i = \case
...
instance Print AbsProgettoPar.CALLEXPRESSION where
  prt i = \case
...
instance Print AbsProgettoPar.NAMEDEXPRESSIONLIST where
  prt i = \case
...
instance Print AbsProgettoPar.NAMEDEXPRESSION where
  prt i = \case
    AbsProgettoPar.NamedExpression expression -> prPrec i 0 (concatD [prt 0 expression])

instance Print AbsProgettoPar.EXPRESSION where
  prt i = \case
    AbsProgettoPar.ExpressionIdent id_ arrayindexelement -> prPrec i 0 (concatD [prt 0 id_, prt 0 arrayindexelement])
    AbsProgettoPar.ExpressionInteger n -> prPrec i 0 (concatD [prt 0 n])
    AbsProgettoPar.ExpressionReal d -> prPrec i 0 (concatD [prt 0 d])
    AbsProgettoPar.ExpressionString str -> prPrec i 0 (concatD [prt 0 str])
    AbsProgettoPar.ExpressionChar c -> prPrec i 0 (concatD [prt 0 c])
...
instance Print AbsProgettoPar.DEFAULT where
  prt i = \case
    AbsProgettoPar.ExpressionIdentD id_ arrayindexelement -> prPrec i 0 (concatD [prt 0 id_, prt 0 arrayindexelement])
    AbsProgettoPar.ExpressionIntegerD n -> prPrec i 0 (concatD [prt 0 n])
    AbsProgettoPar.ExpressionRealD d -> prPrec i 0 (concatD [prt 0 d])
    AbsProgettoPar.ExpressionStringD str -> prPrec i 0 (concatD [prt 0 str])
    AbsProgettoPar.ExpressionCharD c -> prPrec i 0 (concatD [prt 0 c])
...
instance Print AbsProgettoPar.UNARYOP where
  prt i = \case
...
instance Print AbsProgettoPar.BINARYOP where
  prt i = \case
...
instance Print AbsProgettoPar.LVALUEEXPRESSION where
  prt i = \case
...
instance Print AbsProgettoPar.ARRAYINDEXELEMENT where
  prt i = \case
...
instance Print AbsProgettoPar.TYPEINDEX where
  prt i = \case
    AbsProgettoPar.TypeOfIndexInt typeindex n -> prPrec i 0 (concatD [prt 0 typeindex, doc (showString ","), prt 0 n])
    AbsProgettoPar.TypeOfIndexIntSingle n -> prPrec i 0 (concatD [prt 0 n])
