...
buildArrayComments (i:is) (p:ps) dim t = let result = buildPosArrayC (i:is) (p:ps) dim in
                                            let product = buildProductComment ps in
                                                [TacComment ((show ((content_addr_int i)-1))++"*"++product++"sizeof("++show t++")="++show result)] ++ buildArrayComments is ps dim t
...
genTacLeftVal (Abs.LvalueExpressions res@(TResult env _ _) ident@(Abs.Ident id resi) arrayindex lval) n l k (w,j) = case arrayindex of  
                                                                                                    ...
                                                                                                    (Abs.ArrayIndexElement _ typeindex) -> case Data.Map.lookup id env of
                                                                                                        Just (entry:entries) ->  case findEntryOfType (entry:entries) "var" of
                                                                                                            (x:xs) -> case findArray (x:xs) of
                                                                                                                [Variable ty@(Array t _) posv _ _ s] -> let typeIndexTac = genTacTypeIndex typeindex n l k (w,j) in
                                                                                                    ...
                                                                                                    (Abs.ArrayIndexElements _ typeindex arrayIndex) -> case Data.Map.lookup id env of
                                                                                                        Just (entry:entries) ->  case findEntryOfType (entry:entries) "var" of
                                                                                                            (x:xs) -> case findArray (x:xs) of
                                                                                                                [Variable ty@(Array t _) posv _ _ s] -> let realT = getRealTypeFromArray t in
                                                                                                                                                            let typeIndexTac = genTacTypeIndex typeindex n l k (w,j) in
                                                                                                                                                                let arrayIndexTac = genTacArrayIndexElements arrayIndex (sel2 typeIndexTac) l (sel3 typeIndexTac) (w,j) in
                                                                                                                                                                    let lvalAddr = (genTacLeftVal lval (sel2 arrayIndexTac) l (sel3 arrayIndexTac) (w,j)) in
                                                                                                                                                                        let dim = generateDimForArrayFromType ty in
                                                                                                                                                                            let leftAddr = buildIDAddr posv id in
                                                                                                                                                                                let posArr = buildPosArray ((sel4 typeIndexTac)++(sel4 arrayIndexTac)) s dim in
                                                                                                                                                                                    let leftAddrArray = buildArrayId leftAddr posArr 0 in
                                                                                                                                                                                        let comment = TacComment (mergeComments (buildArrayComments ((sel4 typeIndexTac)++(sel4 arrayIndexTac)) s dim realT)) in
                                                                                                                                                                                                ((Abs.LvalueExpressions (TAC [comment] []) (Abs.Ident id (TAC [] [])) (Abs.ArrayIndexElements (TAC [] []) (sel1 typeIndexTac) (sel1 arrayIndexTac)) (sel1 lvalAddr)),(sel2 arrayIndexTac),(sel3 arrayIndexTac),[leftAddrArray])
                                                                                                                                                                    ...
                                                                                                                                                                    let dim = generateDimForArrayFromType ty in
                                                                                                                                                                        let leftAddr = buildIDAddr posv id in
                                                                                                                                                                            let posArr = buildPosArray ((sel4 typeIndexTac)++(sel4 arrayIndexTac)) s dim in
                                                                                                                                                                                let leftAddrArray = buildArrayId leftAddr posArr 0 in
                                                                                                                                                                                    let comment = TacComment (mergeComments (buildArrayComments ((sel4 typeIndexTac)++(sel4 arrayIndexTac)) s dim realT)) in
                                                                                                                                                                                            ((Abs.LvalueExpression (TAC [comment] []) (Abs.Ident id (TAC [] [])) (Abs.ArrayIndexElements (TAC [] []) (sel1 typeIndexTac) (sel1 arrayIndexTac))),(sel2 arrayIndexTac),(sel3 arrayIndexTac),[leftAddrArray])
...
genTacTypeIndex (Abs.TypeOfIndexInt res typeIndex val@(Abs.Integer value resI)) n l k (w,j) = let typeIndexTac = genTacTypeIndex typeIndex n l k (w,j) in
...
genTacArrayIndexElements :: Abs.ARRAYINDEXELEMENTS TCheckResult -> Prelude.Integer -> Label -> Prelude.Integer -> (Label,Label) -> (Abs.ARRAYINDEXELEMENTS  TAC, Prelude.Integer, Prelude.Integer, [Address])
genTacArrayIndexElements (Abs.ArrayIndexElementsSingle _ typeindex) n l k (w,j) = let typeindexTac = genTacTypeIndex typeindex n l k (w,j) in
...
genTacArrayIndexElements (Abs.ArrayIndexElementsMultiple _ typeindex arrayindex) n l k (w,j) = let typeindexTac = genTacTypeIndex typeindex n l k (w,j) in
                                                                                                    let arrayIndexTac = genTacArrayIndexElements arrayindex (sel2 typeindexTac) l (sel3 typeindexTac) (w,j) in
                                                                                    (Abs.ArrayIndexElementsMultiple (mergeTacs [(typeindex_content (sel1 typeindexTac)),
                                                                                                                                (arrayindexelements_content (sel1 arrayIndexTac))]) (sel1 typeindexTac) (sel1 arrayIndexTac),(sel2 arrayIndexTac),(sel3 arrayIndexTac),(sel4 typeindexTac)++(sel4 arrayIndexTac))
...
genTacArrayInit (Abs.ArrayInitSingleElems res listelementarray) n l k (w,j) = let listElementTac = genTacListElementOfArray listelementarray n l k (w,j) in
                                                                                    (Abs.ArrayInitSingleElems (listelementarray_content (sel1 listElementTac)) (sel1 listElementTac),(sel2 listElementTac),(sel3 listElementTac),sel4 listElementTac)
genTacArrayInit (Abs.ArrayInitElems res listelementarray arrayInit) n l k (w,j) = let listElementTac = genTacListElementOfArray listelementarray n l k (w,j) in
                                                                                    let arrayInitTac = genTacArrayInit arrayInit (sel2 listElementTac) l (sel3 listElementTac) (w,j) in
                                                                                        (Abs.ArrayInitElems (mergeTacs [(listelementarray_content (sel1 listElementTac)),
                                                                                                                        (arrayinit_content (sel1 arrayInitTac)) ]) (sel1 listElementTac) (sel1 arrayInitTac),(sel2 arrayInitTac),(sel3 arrayInitTac),(sel4 listElementTac)++(sel4 arrayInitTac))
...
genTacExpression (Abs.ExpressionIdent res ident@(Abs.Ident id resi@(TResult env t pos)) index) n l k (w,j) tres = case Data.Map.lookup id env of
                                                                                                                  Just (entry:entries) -> case findEntryOfType (entry:entries) "var" of
                                                                                                                                            (x@(Variable _ posv _ _ _):xs) -> case index of
                                                                                                                                                                            ...
                                                                                                                                                                            (Abs.ArrayIndexElements _ typeindex arrayIndex) -> case findArray (x:xs) of
                                                                                                                                                                                                                                    [Variable ty@(Array t _) posv _ _ s] -> let realT = getRealTypeFromArray t in
                                                                                                                                                                                                                                                                                let typeIndexTac = genTacTypeIndex typeindex n l k (w,j) in
                                                                                                                                                                                                                                                                                    let arrayIndexTac = genTacArrayIndexElements arrayIndex (sel2 typeIndexTac) l (sel3 typeIndexTac) (w,j) in
                                                                                                                                                                                                                                                                                        let dim = generateDimForArrayFromType ty in
                                                                                                                                                                                                                                                                                            let leftAddr = buildIDAddr posv id in
                                                                                                                                                                                                                                                                                                let posArr = buildPosArray ((sel4 typeIndexTac)++(sel4 arrayIndexTac)) s dim in
                                                                                                                                                                                                                                                                                                    let leftAddrArray = buildArrayId leftAddr posArr 0 in
                                                                                                                                                                                                                                                                                                        let comment = buildArrayComments ((sel4 typeIndexTac)++(sel4 arrayIndexTac)) s dim realT in
                                                                                                                                                                                                                                                                                                            let temp = newTemp (sel2 arrayIndexTac) in
                                                                                                                                                                                                                                                                                                                ((Abs.ExpressionIdent (TAC ([TacAssignNullOp temp leftAddrArray realT]++comment) []) (Abs.Ident id (TAC [] [])) (Abs.ArrayIndexElements (TAC [] []) (sel1 typeIndexTac) (sel1 arrayIndexTac))),(sel2 arrayIndexTac)+1,(sel3 arrayIndexTac),temp)
                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                              let leftAddr = buildIDAddr posv id in
                                                                                                                                                                                                                                                                                                                  let posArr = buildPosArray ((sel4 typeIndexTac)++(sel4 arrayIndexTac)) s dim in
                                                                                                                                                                                                                                                                                                                      let leftAddrArray = buildArrayId leftAddr posArr 0 in
                                                                                                                                                                                                                                                                                                                          let comment = buildArrayComments ((sel4 typeIndexTac)++(sel4 arrayIndexTac)) s dim realT in
                                                                                                                                                                                                                                                                                                                              let temp = newTemp (sel2 arrayIndexTac) in
                                                                                                                                                                                                                                                                                                                                  ((Abs.ExpressionIdentD (TAC ([TacAssignNullOp temp leftAddrArray realT]++comment) []) (Abs.Ident id (TAC [] [])) (Abs.ArrayIndexElements (TAC [] []) (sel1 typeIndexTac) (sel1 arrayIndexTac))),(sel2 arrayIndexTac)+1,(sel3 arrayIndexTac),temp)
