...
genTacStatement (Abs.AssignmentStatement resres@(TResult _ t _) lval assignOp exp) n l k (w,j) tres = let newL = newLabel "" k in
                                                                                    let leftVal = (genTacLeftVal lval n newL k (w,j)) in
                                                                                        let rightVal = (genTacExpression exp (sel2 leftVal) newL (sel3 leftVal) (w,j) tres) in
...
genTacTypeIndex (Abs.TypeOfIndexBinaryPlus res@(TResult env t pos) typeindex expr1 expr2) n l k (w,j) d s p = let typeindexTac = genTacTypeIndex typeindex n l k (w,j) d s (p+1) in
                                                                                                                let expr1Tac = genTacExpression expr1 (sel2 typeindexTac) l (sel3 typeindexTac) (w,j) res in 
                                                                                                                    let expr2Tac = genTacExpression expr2 (sel2 expr1Tac) l (sel3 expr1Tac) (w,j) res in
                                                                                                                        let temp = newTemp (sel2 expr2Tac) in
                                                                                                                            case s of
                                                                                                                                [] ->
...
genTacTypeIndex (Abs.TypeOfIndexBinaryMinusSingle res@(TResult env t pos) expr1 expr2) n l k (w,j) d s p = let expr1Tac = genTacExpression expr1 n l k (w,j) res in 
                                                                                                            let expr2Tac = genTacExpression expr2 (sel2 expr1Tac) l (sel3 expr1Tac) (w,j) res in
                                                                                                                let temp = newTemp (sel2 expr2Tac) in
                                                                                                                    case s of
...
genTacTypeIndex (Abs.TypeOfIndexBinaryProductSingle res@(TResult env t pos) expr1 expr2) n l k (w,j) d s p = let expr1Tac = genTacExpression expr1 n l k (w,j) res in 
                                                                                                        let expr2Tac = genTacExpression expr2 (sel2 expr1Tac) l (sel3 expr1Tac) (w,j) res in
                                                                                                            let temp = newTemp (sel2 expr2Tac) in
                                                                                                                case s of
...
genTacTypeIndex (Abs.TypeOfIndexBinaryDivisionSingle res@(TResult env t pos) expr1 expr2) n l k (w,j) d s p = let expr1Tac = genTacExpression expr1 n l k (w,j) res in 
                                                                                                                let expr2Tac = genTacExpression expr2 (sel2 expr1Tac) l (sel3 expr1Tac) (w,j) res in
                                                                                                                    let temp = newTemp (sel2 expr2Tac) in
                                                                                                                        case s of
...
genTacTypeIndex (Abs.TypeOfIndexBinaryModuleSingle res@(TResult env t pos) expr1 expr2) n l k (w,j) d s p = let expr1Tac = genTacExpression expr1 n l k (w,j) res in 
                                                                                                        let expr2Tac = genTacExpression expr2 (sel2 expr1Tac) l (sel3 expr1Tac) (w,j) res in
                                                                                                            let temp = newTemp (sel2 expr2Tac) in
                                                                                                                case s of
...
genTacTypeIndex (Abs.TypeOfIndexBinaryPowerSingle res@(TResult env t pos) expr1 expr2) n l k (w,j) d s p = let expr1Tac = genTacExpression expr1 n l k (w,j) res in 
                                                                                                        let expr2Tac = genTacExpression expr2 (sel2 expr1Tac) l (sel3 expr1Tac) (w,j) res in
                                                                                                            let temp = newTemp (sel2 expr2Tac) in
                                                                                                                case s of
...
genTacTypeIndex (Abs.TypeOfIndexExpressionBracketSingle res@(TResult env t pos) expr) n l k (w,j) d s p = let exprTac = genTacExpression expr n l k (w,j) res in
                                                                                                                case s of
                                                                                                                    [] ->
...
genTacTypeIndex (Abs.TypeOfIndexExpressionBracket res@(TResult env t pos) typeindex expr) n l k (w,j) d s p = let typeindexTac = genTacTypeIndex typeindex n l k (w,j) d s (p+1) in
                                                                                                                let exprTac = genTacExpression expr (sel2 typeindexTac) l (sel3 typeindexTac) (w,j) res in 
                                                                                                                            case s of
                                                                                                                                [] ->
...
genTacTypeIndex (Abs.TypeOfIndexExpressionCallSingle res@(TResult env t pos) ident@(Abs.Ident id _) exprs) n l k (w,j) d s p = let exprsTac = genTacExpressions exprs n l k (w,j) in
                                                                                                                                let exprCallTac = genTacExpression (Abs.ExpressionCall res ident exprs) (sel2 exprsTac) l (sel3 exprsTac) (w,j) res in
                                                                                                                                    case s of
                                                                                                                                        [] ->
...
genTacTypeIndex (Abs.TypeOfIndexExpressionCall res@(TResult env t pos) typeindex ident@(Abs.Ident id _) exprs) n l k (w,j) d s p = let typeindexTac = genTacTypeIndex typeindex n l k (w,j) d s (p+1) in
                                                                                                                                        let exprsTac = genTacExpressions exprs (sel2 typeindexTac) l (sel3 typeindexTac) (w,j) in
                                                                                                                                            let exprCallTac = genTacExpression (Abs.ExpressionCall res ident exprs) (sel2 typeindexTac) l (sel3 typeindexTac) (w,j) res in
                                                                                                                                                    case s of
                                                                                                                                                        [] ->
...
genTacTypeIndex (Abs.TypeOfIndexVarSingle res@(TResult env t pos) ident@(Abs.Ident id _) arrayIndex) n l k (w,j) d s p = let indexTac = case arrayIndex of
                                                                                                                                            ...
                                                                                                                                            in
                                                                                                                                let exprIdentTac = genTacExpression (Abs.ExpressionIdent res ident arrayIndex) n l k (w,j) res in
                                                                                                                                    case s of
                                                                                                                                        [] ->
                                                                                                                                ...
                                                                                                                                let indexTac = case arrayIndex of
                                                                                                                                            ...
                                                                                                                                            Abs.ArrayIndexElements _ arrayIndexs typeindex -> let typeindexTac = genTacTypeIndex typeindex n l k (w,j) 0 [] (-1) in
                                                                                                                                                                                                let arrayIndexTac = genTacArrayIndexElements arrayIndexs n l k (w,j) 0 [] (-1) in
                                                                                                                                                                                                    Abs.ArrayIndexElements (mergeTacs [(typeindex_content (sel1 typeindexTac)),(arrayindexelements_content (sel1 arrayIndexTac))])  (sel1 arrayIndexTac) (sel1 typeindexTac)
                                                                                                                                            in
                                                                                                                                    let exprIdentTac = genTacExpression (Abs.ExpressionIdent res ident arrayIndex) (sel2 typeindexTac) l (sel3 typeindexTac) (w,j) res in
                                                                                                                                        case s of
                                                                                                                                                        [] ->
